...
import {
  fetchCountries as fetchCountriesR,
  createCountry,
  deleteCountry,
  updateCountry,
} from "../store/services/countryService.js";
...
const Country = () => {
  ...
  const countriesR = useSelector((state) => {
    console.log("R State: ", state.countryReducer);
    return state.countryReducer.countries;
  });
  console.log("CountriesReduxThunk: ", countriesR);
  ...
  useEffect(() => {
    dispatch(fetchCountriesR(currentPage)); //Redux Thunk
    fetchCountries();
